...
public class TokenSecret extends BaseEntity {
     ...
     * @return
     */
    public static TokenSecret newInitInstance(Long userId, Date accessExpireTime, Date refreshExpireTime) {
     ...
     * @return
     */
    public static TokenSecret newUpdateInstance(TokenSecret tokenSecret, Date accessExpireTime, String refreshTokenId) {
        tokenSecret.accessTokenId = UUID.randomUUID().toString();
        tokenSecret.accessTokenSecret = UUID.randomUUID().toString();
